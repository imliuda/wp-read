...
/* ============================================================================================================================================= */
	...
	function pixelwars__widgets_init()
	{
	...
	add_action( 'widgets_init', 'pixelwars__widgets_init' );
							...
							if ( $paged !== (int) 1 && $paged !== (int) 0 && ! is_page() ) 
							{
								?>
									<li class="pagination-first <?php echo $classes; ?>">
										...
										<a href=<?php echo $first_post_link; ?> rel="first"><?php _e( 'First', 'read' ); ?></a>
									</li>
									...
									<li class="pagination-prev <?php echo $classes; ?>">
										<?php 
											...
											else 
											{
												...
												{
													$prev_post_link	= home_url() . '/?paged=' . ( $paged-1 );
												}
										...
										<a href="<?php echo $prev_post_link; ?>" rel="prev"><?php echo $prev_post_title; ?></a>
							...
							if ( $paged !== (int) 0 && $paged !== (int) $max_page && $max_page !== (int) 0 && ! is_page() )
							{
								?>
									<li class="pagination-next<?php echo $classes; ?>">
										<?php 
											...
											else 
											{
												...
												{
													$next_post_link	= home_url() . '/?paged=' . ( $paged + 1 );
												}
											...
											if ( isset( $next_post_obj ) )
											{
												?>
													...
													<a href="<?php echo $next_post_link; ?>" rel="next"><?php echo $next_post_title; ?></a>
												<?php
											}
											else 
											{
									...
									<li class="pagination-last<?php echo $classes; ?>">
										...
										<a href="<?php echo $last_post_link; ?>" rel="last"><?php _e( 'Last', 'read' ); ?></a>
									</li>
								<?php 
							}
						?>
